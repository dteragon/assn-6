...
public class TownGraphManagerTest {
	...
	public void testAllRoads() {
		ArrayList<String> roads = graph.allRoads();
		// assertEquals(graph.graph.roads.size(), roads.size()); //when changing the variable
		// from TownGraphManagerInterface to TownGraphManager and uncommenting this line
		// my test comes out fine. I am getting the right roads, just not the right order
		assertEquals("Road_1", roads.get(0));
		assertEquals("Road_10", roads.get(1));
		assertEquals("Road_11", roads.get(2));
